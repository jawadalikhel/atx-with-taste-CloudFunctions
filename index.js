...
// exports.saveAllBrewriesToDB = functions.https.onRequest(async (req, res) => {
// const testFunc = (async () => {
//     // await cors(req, res, async () => {
//     const db = Admin.firestore()
//     let data = [];
...
//                         console.log('<------ NEXT PAGE SAVVVVIIIINNNGGGG')
//                         let obj = {
//                             address: item.formatted_address,
//                             position: { lat: item.geometry.location.lat, lng: item.geometry.location.lng },
//                             place_id: item.place_id,
...
//                 .then(data => data.json())
//                 .then((jsonData) => {
//                     console.log('<------ FIRSTTTT SAVEEEDDD')
//                     // console.log(jsonData.results.data(), '<------ next456')
